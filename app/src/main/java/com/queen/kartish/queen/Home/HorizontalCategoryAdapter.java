...
public class HorizontalCategoryAdapter extends RecyclerView.Adapter<HorizontalCategoryAdapter.MyHoder>{

    private List<Pair<String,String>> list;
    private Context context;

    HorizontalCategoryAdapter(List<Pair<String,String>> list, Context context) {
        this.list = list;
