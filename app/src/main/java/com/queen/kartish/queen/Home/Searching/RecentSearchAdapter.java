...
public class RecentSearchAdapter extends RecyclerView.Adapter<RecentSearchAdapter.MyHoder>{
    ...
    public void onBindViewHolder(@NonNull final MyHoder holder, @SuppressLint("RecyclerView") final int position) {
        ...
        SearchActivity.edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                if(edit==0) {
                    edit=1;
                    SearchActivity.edit.setText("DONE");
                }
                else{
                    edit=0;
                    SearchActivity.edit.setText("EDIT");
                }

                for (int x=SearchActivity.horzontalrecycle.getChildCount(), i = 0; i < x; ++i) {

                    MyHoder holder = (MyHoder) SearchActivity.horzontalrecycle.getChildViewHolder(SearchActivity.horzontalrecycle.getChildAt(i));
        ...
        holder.cardview.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(edit==1)
                {
                    ...
                    SearchActivity.recsugglist.remove(position);
                    notifyDataSetChanged();

                    if(SearchActivity.recsugglist.size()==0)
                        SearchActivity.recent.setVisibility(View.GONE);
                }
